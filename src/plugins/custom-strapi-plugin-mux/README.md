...
```bash
npm i strapi-plugin-custom-strapi-plugin-mux@latest

yarn add strapi-plugin-custom-strapi-plugin-mux@latest
```

For installing with **Strapi v4**, install v2.0.0—

```bash
npm i strapi-plugin-custom-strapi-plugin-mux@2.8.4

yarn add strapi-plugin-custom-strapi-plugin-mux@2.8.4
```
...
```
{STRAPI_BASE_URL}/custom-strapi-plugin-mux/webhook-handler
```
...
If you encounter an error or have questions, please feel free to file inquiries on the [Issues](https://github.com/muxinc/strapi-plugin-custom-strapi-plugin-mux/issues) page for `strapi-plugin-custom-strapi-plugin-mux`.
